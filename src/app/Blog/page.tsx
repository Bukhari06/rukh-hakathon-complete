...
const BlogPage = () => {
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">Exploring Our Products and Their Benefits</h1>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>Enhances the visual appeal of any room.</li>
          <li>Available in a variety of styles and colors to suit your taste.</li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>Made from durable materials that last for years.</li>
          <li>Available in different shapes and sizes to accommodate your space.</li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>Perfect for both functional use and decorative purposes.</li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>Perfect for formal dining or casual meals.</li>
          <li>Available in various designs to match your table setting.</li>
        </ul>
      </div>

      <div className="mb-8">
        <h2 className="text-2xl font-semibold">5. Tableware - Serve in Style</h2>
        <p className="text-gray-700 mt-2">
          Our collection of tableware includes everything you need to serve your meals in style, from dinner plates and bowls to serving platters and glasses. Each piece is carefully selected to combine functionality with aesthetics, making every meal feel special.
        </p>
        <ul className="list-disc pl-6 mt-2">
          <li>Made with durable materials that are perfect for everyday use.</li>
          <li>Adds a touch of sophistication to your dining experience.</li>
          <li>Available in various designs to match your décor.</li>
        </ul>
      </div>

      <h3 className="text-xl font-semibold text-center mt-12">Conclusion</h3>
